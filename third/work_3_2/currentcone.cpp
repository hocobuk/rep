...
void CurrentCone::show()
{
	...
	cout << "Введите координаты центра нижнего основания: x: " << x << " y: " << y << " z: " << z << endl;
	cout << "Высота конуса: h: " << height << endl;
	cout << "Высота усеченного конуса: h2: " << h2 << endl;
	cout << "Радиус нижнего основания: r: " << radius << endl;
	cout << "Радиус верхнего основания: r2: " << r2 << endl;
}
...
std::ostream& operator << (std::ostream& os, CurrentCone& cone)
{
	...
	return os << "Данные конуса" << endl
		...
		<< "h2: " << cone.h2<< endl
		<< "Площадь: " << cone.getArea() << endl
		<< "Обьем: " << cone.getVolume() << endl;
}
