...
int main()
{
    ...
    my_String[1] = "Сидоров";
    my_String[2] = "Андреев";
    my_String.Add("Николаев");
    my_String.Get("Сидоренко");
    ...
    if (my_String.In_Set("Петров"))
    {
        cout << "Петров is in the my_String." << endl;
    }
    ...
    my_String = my_String + "Иванов";
    cout << "Now Иванов is in the my_String" << endl;
    cout << "my_String size: " << my_String.Size() << endl;
